        ...
        <>
            <section className='page-background'>
                <div className='page-banner-top-title'>
                    <h3><img src={TopIcon} alt='#' /> BSC Non-Fungible Patrons</h3>
                    <select>
                ...
                <div className='nfp-banner-center-text'>
                    ...
                    <p>Non-Fungible Patrons (NFPs) give you ultimate perks on Gas Station’s Bridge. Like free transactions on the bridge or earning a pool of bridge transaction fees.</p>
                        ...
                        <div className='card-box'>
                            ...
                            <div className='image-box'>
                                ...
                                <div className='price-block'>
                                    <h2>$25 <small>USDC</small></h2>
                                    <small>CURRENT PRICE</small>
                                    <img src={Right} />
                                </div>
                            </div>
                            <span className='drow-line'></span>
                            <p className='desc'>Common patrons are algrithmically generate NFTs. Own one to enjoy free transfers on Gas Station Bridge.</p>
            ...
            <section className='collection-list px-15'>
                <div className='title-main'>
                    ...
                    <p>We’re showing all NFPs in your current wallet on the BSC network. How do I see my other NFPs?</p>
                </div>
                <div className='row'>
