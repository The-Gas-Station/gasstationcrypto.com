						...
						<div className="col-md-7 col-xl-7 col-xxl-6">
							<div className="grid-block">
								...
								<div className="grid-list-icon d-none d-md-flex">
									<span className={isCardGride ? '' : 'active'} onClick={() => setIsCardGride(false)}>
										<svg width="18" height="12" viewBox="0 0 18 12" fill="none" xmlns="http://www.w3.org/2000/svg">
											<path d="M0.600006 11C0.600006 11.5523 1.04772 12 1.60001 12H16.4C16.9523 12 17.4 11.5523 17.4 11V10.6C17.4 10.0477 16.9523 9.6 16.4 9.6H1.60001C1.04772 9.6 0.600006 10.0477 0.600006 10.6V11ZM1.60001 0C1.04772 0 0.600006 0.447715 0.600006 1V1.4C0.600006 1.95229 1.04772 2.4 1.60001 2.4H16.4C16.9523 2.4 17.4 1.95228 17.4 1.4V0.999999C17.4 0.447715 16.9523 0 16.4 0H1.60001ZM0.600006 6.2C0.600006 6.75229 1.04772 7.2 1.60001 7.2H16.4C16.9523 7.2 17.4 6.75228 17.4 6.2V5.8C17.4 5.24771 16.9523 4.8 16.4 4.8H1.60001C1.04772 4.8 0.600006 5.24772 0.600006 5.8V6.2Z" fill="#8A92A6" />
										</svg>
									</span>
									<span className={isCardGride ? 'active' : ''} onClick={() => setIsCardGride(true)}>
										<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
											<path d="M0 1C0 0.447715 0.447715 0 1 0H3C3.55228 0 4 0.447715 4 1V3C4 3.55228 3.55228 4 3 4H1C0.447715 4 0 3.55228 0 3V1Z" fill="#8A92A6" />
											<path d="M0 7C0 6.44772 0.447715 6 1 6H3C3.55228 6 4 6.44772 4 7V9C4 9.55228 3.55228 10 3 10H1C0.447715 10 0 9.55228 0 9V7Z" fill="#8A92A6" />
											<path d="M4 13C4 12.4477 3.55228 12 3 12H1C0.447715 12 0 12.4477 0 13V15C0 15.5523 0.447715 16 1 16H3C3.55228 16 4 15.5523 4 15V13Z" fill="#8A92A6" />
											<path d="M6 1C6 0.447715 6.44772 0 7 0H9C9.55228 0 10 0.447715 10 1V3C10 3.55228 9.55228 4 9 4H7C6.44772 4 6 3.55228 6 3V1Z" fill="#8A92A6" />
											<path d="M10 7C10 6.44772 9.55228 6 9 6H7C6.44772 6 6 6.44772 6 7V9C6 9.55228 6.44772 10 7 10H9C9.55228 10 10 9.55228 10 9V7Z" fill="#8A92A6" />
											<path d="M6 13C6 12.4477 6.44772 12 7 12H9C9.55228 12 10 12.4477 10 13V15C10 15.5523 9.55228 16 9 16H7C6.44772 16 6 15.5523 6 15V13Z" fill="#8A92A6" />
											<path d="M16 1C16 0.447715 15.5523 0 15 0H13C12.4477 0 12 0.447715 12 1V3C12 3.55228 12.4477 4 13 4H15C15.5523 4 16 3.55228 16 3V1Z" fill="#8A92A6" />
											<path d="M12 7C12 6.44772 12.4477 6 13 6H15C15.5523 6 16 6.44772 16 7V9C16 9.55228 15.5523 10 15 10H13C12.4477 10 12 9.55228 12 9V7Z" fill="#8A92A6" />
											<path d="M16 13C16 12.4477 15.5523 12 15 12H13C12.4477 12 12 12.4477 12 13V15C12 15.5523 12.4477 16 13 16H15C15.5523 16 16 15.5523 16 15V13Z" fill="#8A92A6" />
										</svg>
									</span>
								</div>
