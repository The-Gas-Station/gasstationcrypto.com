...
import MetMask from '../assets/metamask_ico_1.png';
            ...
            <div className="amount-sections meta-mask-block d-block d-lg-none">
              <div className="amount-row">
                <div className="amount-col custom-select-box flex-row py-0">
                  ...
                  <div className="">
                    <img src={MetMask} alt="icons" />
                  </div>
                </div>
              </div>
            </div>
            <div className={`row inner-content d-none d-lg-flex ${isMobile ? 'd-none d-lg-block' : ''}`}>
                  ...
                  <Slider {...settings}>
                    <div className="amount-row">
                      <div className="amount-col p-0 text-white">
                        <img src={Ftm} alt="ftm" style={{ width: 24 }} />
                      </div>
